    ...
    <div class="container-login100">
        <div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
            <form action="proses_login.php" method="POST" class="login100-form validate-form">
                ...
                <div class="wrap-input100 validate-input m-b-16" data-validate="Masukkan Email yang valid">
                    <input class="input100" type="text" name="username" placeholder="Username" required>
                    <span class="focus-input100"></span>
                    <span class="symbol-input100"><span class="lnr lnr-envelope"></span></span>
                </div>

                <div class="wrap-input100 validate-input m-b-16" data-validate="Masukkan Password anda">
                ...
                <div class="text-center w-full p-t-115">
                    ...
                    <a class="txt1 bo1 hov1" href="daftar.php">Sign up now</a>
                </div>
            </form>
        </div>
    </div>
